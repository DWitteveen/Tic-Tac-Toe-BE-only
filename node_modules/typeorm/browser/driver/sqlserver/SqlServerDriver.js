...
var SqlServerDriver = /** @class */ (function () {
    ...
    SqlServerDriver.prototype.findChangedColumns = function (tableColumns, columnMetadatas) {
        ...
        return columnMetadatas.filter(function (columnMetadata) {
            ...
            return tableColumn.name !== columnMetadata.databaseName
                ...
                || (!tableColumn.isGenerated && !_this.compareDefaultValues(_this.normalizeDefault(columnMetadata), tableColumn.default)) // we included check for generated here, because generated columns already can have default values
     ...
     */
    SqlServerDriver.prototype.compareDefaultValues = function (columnMetadataValue, databaseValue) {
