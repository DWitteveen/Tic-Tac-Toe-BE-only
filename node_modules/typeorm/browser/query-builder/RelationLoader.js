...
var RelationLoader = /** @class */ (function () {
     ...
     */
    RelationLoader.prototype.load = function (relation, entityOrEntities) {
     ...
     */
    RelationLoader.prototype.loadManyToOneOrOneToOneOwner = function (relation, entityOrEntities) {
     ...
     */
    RelationLoader.prototype.loadOneToManyOrOneToOneNotOwner = function (relation, entityOrEntities) {
        var entities = entityOrEntities instanceof Array ? entityOrEntities : [entityOrEntities];
     ...
     */
    RelationLoader.prototype.loadManyToManyOwner = function (relation, entityOrEntities) {
        var entities = entityOrEntities instanceof Array ? entityOrEntities : [entityOrEntities];
     ...
     */
    RelationLoader.prototype.loadManyToManyNotOwner = function (relation, entityOrEntities) {
        var entities = entityOrEntities instanceof Array ? entityOrEntities : [entityOrEntities];
        var mainAlias = relation.propertyName;
        var joinAlias = relation.junctionEntityMetadata.tableName;
