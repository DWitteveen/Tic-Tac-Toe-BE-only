            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.query("INSERT INTO " + this.escapeTableName(tableName) + "(`ancestor`, `descendant`, `level`) " +
                                ("SELECT `ancestor`, `" + newEntityId + "`, `level` + 1 FROM " + this.escapeTableName(tableName) + " WHERE `descendant` = " + parentId + " ") +
                                ("UNION ALL SELECT `" + newEntityId + "`, `" + newEntityId + "`, 1"))];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.query("INSERT INTO " + this.escapeTableName(tableName) + "(`ancestor`, `descendant`) " +
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.query("SELECT MAX(`level`) as `level` FROM " + this.escapeTableName(tableName) + " WHERE `descendant` = " + parentId)];
                    case 5:
                        results = _a.sent();
